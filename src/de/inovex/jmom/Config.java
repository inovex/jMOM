...
import de.inovex.jmom.exception.NumericException;

/**
 * An {@code Config} object holds all the configuration for a specific {@link Storage}
 * instance. Have a look at the different methods of this class, to check the
